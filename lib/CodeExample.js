...
var CodeExample = (function (_React$Component) {
  ...
  _createClass(CodeExample, [{
    ...
    value: function update() {
      ...
      _CodeMirrorSettings.CodeMirror.runMode(this.props.codeText, this.props.mode, _reactDom2['default'].findDOMNode(this).children[0]);
    }
  }, {
    key: 'render',
    value: function render() {
      var classes = (0, _classnames2['default'])('code-example', 'CodeMirror', this.props.className);
